...
class ProductVersion(Base):
    ...
    label_market: Mapped[str] = mapped_column(String(16), default="UNKNOWN")
    label_language: Mapped[str] = mapped_column(String(16), default="unknown")
    ...
    sodium_mg: Mapped[Decimal | None] = mapped_column(Numeric(12, 4), nullable=True)
    salt_equivalent_g: Mapped[Decimal | None] = mapped_column(Numeric(12, 4), nullable=True)
    sodium_derived: Mapped[bool] = mapped_column(Boolean, default=False)
    salt_equivalent_derived: Mapped[bool] = mapped_column(Boolean, default=False)
    estimated_values: Mapped[bool] = mapped_column(Boolean, default=False)
    source: Mapped[str] = mapped_column(String(32), default="user")

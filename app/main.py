    ...
    health_server = uvicorn.Server(
        uvicorn.Config(
            create_health_app(
                ...
                dashboard_writes_enabled=settings.dashboard_writes_enabled,
                cloudflare_access_team_domain=settings.cloudflare_access_team_domain,
                cloudflare_access_aud=settings.cloudflare_access_aud,
                cloudflare_access_allowed_email=settings.cloudflare_access_allowed_email,
            ),
